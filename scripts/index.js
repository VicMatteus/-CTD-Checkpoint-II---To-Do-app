...
form.onclick = (function (validar) {
  ...
  fetch("https://ctd-todo-api.herokuapp.com/v1/users/login", {
    ...
    //V: isso não faz sentido, mas vou analisar melhor só depois.
      localStorage.setItem("jwt", response.jwt) //a função irá receber como parametro a resposta do .then anterior e irá retornar a chave jwt e armazenar no computador do usúario através de localStore. 
